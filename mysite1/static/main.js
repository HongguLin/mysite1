...
/* harmony import */ var _routes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./routes.module */ "./src/app/routes.module.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _routes_module__WEBPACK_IMPORTED_MODULE_7__["RoutesModule"]
            ],
            providers: [_shared_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"]],
...
module.exports = "<nav class=\"navbar navbar-expand-xl navbar-light bg-light\">\n  <a  class=\"navbar-brand navbar-left\" href=\"\">Logo</a>\n  <ul class=\"nav navbar-nav ml-auto\">\n    <li class=\"nav-item mr-md-2\">\n      <a class=\"nav-link\" href=\"\"> Text </a>\n    </li>\n    <li class=\"nav-item mr-md-2\">\n      <a class=\"nav-link\" href=\"\"> Draw </a>\n    </li>\n    <li class=\"nav-item mr-md-4\">\n      <a class=\"nav-link\" href=\"\"> Game </a>\n    </li>\n    <li class=\"nav-item\" [style.display]=\"user ? 'none': 'block'\">\n        <a class=\"nav-link btn btn-sm btn-outline-secondary mr-md-2\" href=\"/signup\">Register</a>\n    </li>\n    <li class=\"nav-item\" [style.display]=\"user ? 'none': 'block'\">\n        <a class=\"nav-link btn btn-sm btn-outline-secondary mr-md-2\" href=\"/signin\">Login</a>\n    </li>\n    <li class=\"nav-item\" *ngIf=\"user\">\n        <div class=\"dropdown\">\n            <button type=\"button\" class=\"btn btn-lg btn-outline-secondary dropdown-toggle\" data-toggle=\"dropdown\">\n              {{user.Username}}\n            </button>\n            <div class=\"dropdown-menu dropdown-menu-right\">\n              <a class=\"dropdown-item\" href=\"#\">View profile</a>\n              <a class=\"dropdown-item\" (click)=\"Logout()\">Logout</a>\n            </div>\n          </div>\n    </li>\n  </ul>\n</nav>\n<div class=\"container\">\n  <p>Here is your own joyspace!</p>\n</div>\n"
...
/*!**********************************!*\
  !*** ./src/app/routes.module.ts ***!
  \**********************************/
/*! exports provided: appRoutes, RoutesModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var UserService = /** @class */ (function () {
    function UserService(http) {
        this.http = http;
        this.rootUrl = 'http://127.0.0.1:8000/blog/';
    }
    UserService.prototype.userRegister = function (user) {
        ...
        return this.http.post(this.rootUrl + 'user/', body, httpOptions);
    };
    UserService.prototype.userAuthentication = function (username, password) {
        ...
        return this.http.post(this.rootUrl + 'login/', body, httpOptions);
    };
...
module.exports = "<form class=\"form-signin\" name=\"userSigninForm\" (ngSubmit)=\"OnSubmit(Username, Password)\">\n    <div class=\"form-group\">\n      <input class=\"form-control\" type=\"text\" placeholder=\"Username\" name=\"Username\"  [(ngModel)]=\"username\" required>\n    </div>\n  \n    <div class=\"form-group\">\n      <input class=\"form-control\"  type=\"password\" placeholder=\"Password\" name=\"Password\" [(ngModel)]=\"password\" required>\n    </div>\n  \n    <button class=\"btn btn-primary btn-block\" type=\"submit\">Sign In</button>\n  </form>\n  \n"
...
var SignInComponent = /** @class */ (function () {
    ...
    SignInComponent.prototype.OnSubmit = function (form) {
        ...
        this.userService.userAuthentication(this.username, this.password)
...
module.exports = __webpack_require__(/*! /Users/linhonggu/Desktop/frontend/src/main.ts */"./src/main.ts");
